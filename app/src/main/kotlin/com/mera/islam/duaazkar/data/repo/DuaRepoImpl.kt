...
class DuaRepoImpl(
    ...
    override fun getDuaByDuaType(duaType: DuaType): Flow<List<DuaModel>> = duaDao.getDuaByDuaType(duaType.type).mapper()
    override fun getDuaById(id: Int): Flow<DuaModel> = duaDao.getDuaById(id).map { value: DuaEntity ->
